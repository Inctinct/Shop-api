...
from .models import Product, Category, Discount, Producer, Promocode, RegistredUser, Order, Cashback, Comment
...
class ProductSerializer(ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'name', 'description', 'producer', 'category',
                  'discount', 'price', 'articul', 'count_on_stock']
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    def calculate_result_price(self, data):
        ...
        product_items = Product.objects.filter(id__in=product_items_ids).values('id', 'price',
                                                                                    'discount__percent',
