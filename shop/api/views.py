...
from .models import Category, Producer, Promocode, Discount, Product, RegistredUser, Basket
from .serializers import CategorySerializer, ProducerSerializer, ProductSerializer, PromocodeSerializer, DiscountSerializer,RegistrationSerializer,\
    LoginSerializer, BasketSerializer, AddProductsSerializer, DeleteProductSerializer, OrderSerializer, ProductDetailSerializer
...
class ProductListView(ListAPIView):
    queryset = Product.objects.all().\
        values('id', 'name', 'description', 'producer', 'category', 'discount', 'price', 'articul', 'count_on_stock')
...
class SingleProductView(APIView):
    ...
    def get(self, request, product_id):
        queryset = Product.objects.prefetch_related('comment_set').filter(id=product_id).values(
...
class BasketView(APIView):
    ...
    def get(self, request):
        user = request.user
        basket = Product.objects.prefetch_related("basket_set").filter(basket__user=user) \
